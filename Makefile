...
# Phony Targets
.PHONY: all serial openmp convert cuda clean help

all: serial openmp convert cuda
...
clean:
	rm -f $(SERIAL_EXE) $(OPENMP_EXE) $(CONVERT_EXE) $(CUDA_EXE)
	rm -f cuda/*.exe cuda/*.exp cuda/*.lib

# Help description
help:
	@echo "Available make targets:"
	@echo "  make all       - Build Serial, OpenMP, Converter, and CUDA targets"
